...
elife-xpub-environment-variables-for-configuration:
    file.managed:
        ...
        - contents: |
            ...
            export MECA_SFTP_HOST={{ pillar.elife_xpub.meca.sftp.connectionOptions.host }}
            export MECA_SFTP_PORT={{ pillar.elife_xpub.meca.sftp.connectionOptions.port }}
            export MECA_SFTP_USERNAME={{ pillar.elife_xpub.meca.sftp.connectionOptions.username }}
            export MECA_SFTP_PASSWORD={{ pillar.elife_xpub.meca.sftp.connectionOptions.password }}
